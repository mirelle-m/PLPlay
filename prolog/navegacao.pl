...
% ------------------------------
% Loop de navegação com título string
% ------------------------------
...
% --- get_key/1 (MÉTODO NOVO E ROBUSTO) ---
% Lê um único caractere sem esperar pelo Enter. Funciona em Windows, Linux e macOS.
get_key(Key) :-
