...
missao(4, 'Missão 4: Paradigma Imperativo').
missao(5, 'Missão 5: Chefao 1').
missao(6, 'Missão 6: Paradigma Funcional').
missao(7, 'Missão 7: Chefao 2').
missao(8, 'Missão 8: Paradigma Lógico').
missao(9, 'Missão 9: Chefao 3 ').